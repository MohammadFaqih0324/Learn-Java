...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("komponen pertama dari char[] = " + kataChar[2]);
        System.out.println("komponen pertama dari String = " + kataString.charAt(4));
        ...
        // memory di java itu ada 3 : 1.Heap, 2.stuck, 3.String pool
        ...
        // 2. String yang berada di srting poool itu akan reuseable,
        // memorynya lebih efisien
        // 3. Membuat string dengan method baru, maka dia akan di taro
    ...
    private static void printAddress(String nama, String data){
        ...
        System.out.println(nama + " = " + data + "\t|| adddress = " + Integer.toHexString(address));
    }
}
