...
public class Operasi {
    public static void updateData() throws IOException {
        ...
        System.out.print("\nMasukan nomor buku yang akan anda diupdate: ");
        ...
        while(data != null){
            ...
            if(updateNum == entryCounts){
                ...
                if(isUpdate){
                    ...
                    if(isExist){
                        System.err.println("data buku sudah ada di database, proses update di batalkan, silahkan delete data yang bersangkutan");
